Lbdevelopmentv03::Application.routes.draw do
  ...
  match 'channels/food', to: "channels#index", :channel_id => "2"
  match 'channels/lecture', to: "channels#index", :channel_id => "3"
  match 'channels/local', to: "channels#index", :channel_id => "4"
  match 'channels/nightlife', to: "channels#index", :channel_id => "5"
  match 'channels/sports', to: "channels#index", :channel_id => "6"
